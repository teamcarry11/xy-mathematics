...
pub fn build(b: *std.Build) void {
    ...
    // Aurora Folding module (for test imports)
    ...
    // Aurora Text Renderer module (for test imports)
    ...
    const grain_flow_workflow_observatory_tests = b.addTest(.{
        .root_module = b.createModule(.{
            .root_source_file = b.path("tests/143_grain_flow_workflow_observatory_test.zig"),
            .target = target,
            .optimize = optimize,
            .imports = &.{
                .{ .name = "grain_flow", .module = grain_flow_module },
    ...
    const grain_research_workflow_metrics_integration_tests = b.addTest(.{
        .root_module = b.createModule(.{
            .root_source_file = b.path("tests/145_grain_research_workflow_metrics_integration_test.zig"),
            .target = target,
            .optimize = optimize,
            .imports = &.{
                .{ .name = "grain_research", .module = grain_research_module },
