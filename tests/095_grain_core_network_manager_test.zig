...
const NetworkManager = grain_core.network_manager.NetworkManager;
const InterfaceType = grain_core.network_manager.InterfaceType;
const IpAddressType = grain_core.network_manager.IpAddressType;
...
test "network manager constants" {
    std.debug.assert(grain_core.network_manager.MAX_INTERFACES == 16);
    std.debug.assert(grain_core.network_manager.MAX_INTERFACE_NAME_LEN == 64);
    std.debug.assert(grain_core.network_manager.MAX_IP_LEN == 46);
}
