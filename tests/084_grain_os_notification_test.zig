...
const NotificationManager = grain_os.notification.NotificationManager;
const NotificationPriority = grain_os.notification.NotificationPriority;
...
test "notification constants" {
    std.debug.assert(grain_os.notification.MAX_NOTIFICATIONS == 32);
    std.debug.assert(grain_os.notification.MAX_TITLE_LEN == 128);
    std.debug.assert(grain_os.notification.MAX_MESSAGE_LEN == 512);
    std.debug.assert(grain_os.notification.DEFAULT_TIMEOUT_MS == 5000);
}
