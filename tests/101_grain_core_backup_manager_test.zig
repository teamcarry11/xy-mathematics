...
test "backup manager constants" {
    std.debug.assert(grain_core.backup_manager.MAX_BACKUPS == 32);
    std.debug.assert(grain_core.backup_manager.MAX_BACKUP_NAME_LEN == 128);
    std.debug.assert(grain_core.backup_manager.MAX_BACKUP_PATH_LEN == 512);
    std.debug.assert(grain_core.backup_manager.MAX_BACKUP_DESC_LEN == 256);
}
