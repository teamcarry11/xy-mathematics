...
const SettingsManager = grain_core.settings_manager.SettingsManager;
const SettingValueType = grain_core.settings_manager.SettingValueType;
...
test "settings constants" {
    std.debug.assert(grain_core.settings_manager.MAX_SETTINGS == 256);
    std.debug.assert(grain_core.settings_manager.MAX_KEY_LEN == 64);
    std.debug.assert(grain_core.settings_manager.MAX_VALUE_LEN == 256);
    std.debug.assert(grain_core.settings_manager.MAX_CATEGORIES == 16);
}
