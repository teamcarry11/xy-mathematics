...
const DisplayManager = grain_core.display_management.DisplayManager;
const DisplayConnection = grain_core.display_management.DisplayConnection;
const DisplayState = grain_core.display_management.DisplayState;
...
test "display constants" {
    std.debug.assert(grain_core.display_management.MAX_DISPLAYS == 8);
    std.debug.assert(grain_core.display_management.MAX_DISPLAY_NAME_LEN == 64);
}
