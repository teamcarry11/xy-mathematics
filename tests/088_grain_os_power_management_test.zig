...
const PowerManagementManager = grain_os.power_management.PowerManagementManager;
const PowerState = grain_os.power_management.PowerState;
const BatteryState = grain_os.power_management.BatteryState;
