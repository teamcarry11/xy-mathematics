...
const PackageManager = grain_core.package_manager.PackageManager;
const PackageState = grain_core.package_manager.PackageState;
...
test "package manager constants" {
    std.debug.assert(grain_core.package_manager.MAX_PACKAGES == 256);
    std.debug.assert(grain_core.package_manager.MAX_PACKAGE_NAME_LEN == 128);
    std.debug.assert(grain_core.package_manager.MAX_PACKAGE_VERSION_LEN == 32);
    std.debug.assert(grain_core.package_manager.MAX_PACKAGE_DESC_LEN == 256);
    std.debug.assert(grain_core.package_manager.MAX_DEPENDENCIES == 16);
}
