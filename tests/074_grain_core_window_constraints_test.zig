...
const WindowConstraints = grain_core.window_constraints.WindowConstraints;

test "constraints initialization" {
    const constraints = WindowConstraints.init();
    std.debug.assert(constraints.min_width == grain_core.window_constraints.DEFAULT_MIN_WIDTH);
    std.debug.assert(constraints.min_height == grain_core.window_constraints.DEFAULT_MIN_HEIGHT);
    std.debug.assert(constraints.max_width == grain_core.window_constraints.DEFAULT_MAX_WIDTH);
    std.debug.assert(constraints.max_height == grain_core.window_constraints.DEFAULT_MAX_HEIGHT);
    std.debug.assert(constraints.aspect_ratio == grain_core.window_constraints.DEFAULT_ASPECT_RATIO);
}
