...
const ProcessSupervisor = grain_os.process_supervision.ProcessSupervisor;
const SupervisionPolicy = grain_os.process_supervision.SupervisionPolicy;
const SupervisionState = grain_os.process_supervision.SupervisionState;
...
test "process supervision constants" {
    std.debug.assert(grain_os.process_supervision.MAX_SUPERVISED_PROCESSES == 64);
    std.debug.assert(grain_os.process_supervision.MAX_POLICY_NAME_LEN == 64);
}
