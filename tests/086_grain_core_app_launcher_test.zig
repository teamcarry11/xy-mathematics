...
const ApplicationLauncher = grain_core.app_launcher.ApplicationLauncher;
...
test "app launcher constants" {
    std.debug.assert(grain_core.app_launcher.MAX_APPS == 256);
    std.debug.assert(grain_core.app_launcher.MAX_SEARCH_RESULTS == 32);
    std.debug.assert(grain_core.app_launcher.MAX_FAVORITES == 16);
    std.debug.assert(grain_core.app_launcher.MAX_RECENT_APPS == 16);
    std.debug.assert(grain_core.app_launcher.MAX_QUERY_LEN == 128);
}
